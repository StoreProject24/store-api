...
SubcategoriesController.post('/', [verifyTokenAdminStore, ...validationCreateSubcategory], async (req: Request, res: Response) => {
  try {
...
SubcategoriesController.put('/:id', [verifyTokenAdminStore, ...validationUpdateSubcategory], async (req: Request, res: Response) => {
  try {
    const subcategoriesDomain = new SubcategoriesDomain();
...
SubcategoriesController.delete('/:storeId/:id', [verifyTokenAdminStore, ...validationDeleteSubcategory], async (req: Request, res: Response) => {
  try {
    const subcategoriesDomain = new SubcategoriesDomain();
